...
describe("Order Model", function () {
    ...
    it('addproduct method should add product to user order', function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    it('complete method should change order status to complete', function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, store.complete(1)];
                case 1:
                    result = _a.sent();
                    expect(result.id).toEqual(1);
                    expect(result.user_id).toEqual(1);
